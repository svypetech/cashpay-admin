                ...
                <div className="flex h-full flex-col overflow-y-auto">
                    ...
                    <div className="flex flex-col items-center px-6 py-8 font-[satoshi]">
                        ...
                        <div className="mb-4 h-32 w-32 overflow-hidden rounded-full">
                            <Image
                                src={order.userDetails.image || "/images/blank-profile.webp"}
                                alt={"user image"}
                                width={128}
                                height={128}
                        ...
                        {/* User Info */}
                        <h3 className="mb-1 text-xl font-semibold">{`${order.userDetails.name.firstName} ${order.userDetails.name.lastName}`}</h3>
                        ...
                        <div className="flex flex-col justify-center mb-6" >
                            ...
                            <div className="mb-2 flex w-full items-center">
                                <div className="flex w-full gap-5">
                                    ...
                                    <span className="text-sm">{formatDate(order.userDetails.joinDate)}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-center" >
                            <div className="mb-4 flex w-full items-center justify-between gap-10">
                                <h4 className="text-2xl font-semibold">{order.cardType === "Virtual Card" ? "Virtual Card" : "Physical Card"}</h4>
                            ...
                            <div className="mb-4 flex w-full items-center justify-between gap-10">
                                ...
                                <p className="text-sm text-gray-800">{formatDate(order.date)}</p>
                            </div>
                            {order.orderStatus != "Dispatched" && <div className="mb-4 flex w-full items-center justify-between gap-10">
                                ...
                                <p className="text-sm text-gray-800">{order.deliveryAddress || "N/A"}</p>
                            </div>}
                        </div>
                    </div>
                </div>
