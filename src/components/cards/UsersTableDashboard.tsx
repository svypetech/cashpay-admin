  ...
  return (
    <div className="bg-white rounded-lg shadow-sm md:p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <a href="/users" className="text-secondary text-sm flex items-center">
          View All
        ...
        <table className="w-full text-left table-fixed min-w-30">
          ...
          <tbody>
            {Array.isArray(data) &&
              data.map((user, index) => (
                <tr
                  key={index} className="border-b text-[8px] sm:text-[12px]">
                  ...
                  <td className="p-2 sm:p-4 font-satoshi w-1/6 min-w-0 relative">
                    {user.status === "Verified" ? (
                      <span className="px-2 text-[12px] sm:text-[16px] md:px-4 py-3 md:py-4 font-satoshi min-w-[120px] whitespace-nowrap bg-[#71FB5533] text-[#20C000] rounded-xl font-semibold">
                        Verified
                      </span>
                    ) : (
                      <span className="px-2 text-[12px] sm:text-[16px] md:px-4 py-3 md:py-4 font-satoshi min-w-[120px] whitespace-nowrap text-[#727272] bg-[#72727233] rounded-xl font-semibold">
                        Pending
                      </span>
                    )}
                  </td>
