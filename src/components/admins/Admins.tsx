...
export default function Admins() {
  ...
  const {
    ...
    error,
    totalPages,
  } = useGetAdmins(currentPage, 10, sortBy);
  ...
  return (
    <div>
              ...
              role.title != "Super Admin" && (
                <button
                  ...
                  className={`px-4 py-2 text-black ${
                    activeTab === role.title.toLowerCase()
      ...
      {/* Search and Actions */}
      <div
        className={`flex flex-col md:grid md:grid-cols-8 justify-between items-center mb-2 gap-4`}
      >
