...
import { groupP2PMessagesByDate } from '@/src/lib/functions';
import { P2PMessage } from '@/src/Types/chat';
import P2PMessageItem from './P2PMessageItem';
...
export default function P2PMessageList({ 
  messages, 
  className, 
  currentUserId,
  tempMessageIds = [],
  ...
  const messageGroups = useMemo(() => {
    return groupP2PMessagesByDate(processedMessages);
  }, [processedMessages]);
